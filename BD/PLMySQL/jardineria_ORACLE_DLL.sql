-------------------------------------
-- Usuario: SYSTEM / Contraseña:DAWBD
-------------------------------------

-- Crear el usuario nuevo de base de datos

sqlplus / as SYSDBA	(sin contraseña)

-- El nombre del usuario debe llevar delante c##
CREATE USER c##jardineria IDENTIFIED BY jardineria QUOTA UNLIMITED ON USERS;

-- darle permisos para iniciar sesion y crear tablas
GRANT CREATE SESSION,CREATE TABLE TO c##jardineria;

-- y para que pueda crear/ejecutar procedimientos plsql
GRANT CREATE PROCEDURE TO c##jardineria;

exit

-- entrar a sqlplus como el nuevo usuario
sqlplus c##jardineria/jardineria

-- o 

sqlplus
	usuario: c##jardineria
	contraseña: jardineria
...
-- Crear las tablas de la base de datos e insertar datos
